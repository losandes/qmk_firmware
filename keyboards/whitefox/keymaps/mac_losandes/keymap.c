...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      ...
      */
    [0] = LAYOUT_truefox( \
        KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  _______, _______, KC_GRV,  \
    ...
    [1] = LAYOUT_truefox( \
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,      _______,     KC__MUTE, \
