...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          XXXXXXX, LYR_2,   \
        LYR_1,   KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, KC_RALT, XXXXXXX, XXXXXXX, XXXXXXX  \
    ),
    ...
    [2] = LAYOUT(
        ...
        KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_UP,   XXXXXXX, KC_BSPC, XXXXXXX,  \
        XXXXXXX, KC_VOLD, KC_VOLU, KC__MUTE,XXXXXXX, XXXXXXX, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RIGHT,         KC_ENT,  XXXXXXX,  \
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PPLS, KC_PMNS, KC_END,  KC_PGDN, KC_DOWN, XXXXXXX,          XXXXXXX, XXXXXXX,  \
